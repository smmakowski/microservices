...
describe('helper functions', function() {
  describe('createHeadersObject', function() {
    ...
    it('return an object with keys: ipaddress, language, & software', function() {
      expect(parserObj).to.be.an('object');
      expect(parserObj).to.have.keys('ipaddress', 'language', 'software');
    });
    it ('the object should have the required values', function() {
      expect(parserObj.ipaddress).to.equal('192.168.1.10');
